...
namespace AutoUpdate
{
    ...
    public class AppUpdater : IDisposable
    {
        ...
        {
            string localPackage = Application.StartupPath + "\\" + AuPackage.Name;
            ...
            string package = ToolsHelp.DownAutoUpdateFile(this.My, tempUpdatePath, AuPackage.Name);
        ...
        ///// </summary>
        ///// <returns></returns>
        //public void DownAutoUpdateFile(string url, string downpath, string filename)
        //{
